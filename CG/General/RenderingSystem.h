...
private:
    void BuildGeometryRootSignature(ID3D12Device*);
    void BuildLightingRootSignature(ID3D12Device*); 
    void BuildShadowRootSignature(ID3D12Device*);
    void BuildPSOs(ID3D12Device*,DXGI_FORMAT); 
    void BuildLightingDescriptors(ID3D12Device*); 
    void BuildShadowResources(ID3D12Device*); 
    void BuildShaders();
